...
public class VoisentryAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	static private String currentVersion = VoisentryConstants.VERSION;
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(VoisentryAuthNodePlugin.currentVersion,
						Arrays.asList(VoisentryNodeCheck.class, VoisentryNodeDelete.class, VoisentryNodeEnrol.class, VoisentryNodeVerify.class, VoisentryNodeEnrolidCollector.class, VoisentryNodeAudioCollector.class, VoisentryNodeUpdate.class));
	}
