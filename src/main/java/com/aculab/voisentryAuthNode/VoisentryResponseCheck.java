 ...
 */
public class VoisentryResponseCheck extends VoisentryResponse {
    
    private List<String> enrolids;


    public VoisentryResponseCheck (String response) throws NodeProcessException {
        ...
        try {
            ...
            Logger logger = LoggerFactory.getLogger(VoisentryResponseCheck.class);
