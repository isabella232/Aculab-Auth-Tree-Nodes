 ...
 */
@Node.Metadata(outcomeProvider  = VoisentryNodeUpdate.VoisentryUpdateNodeOutcomeProvider.class,
               configClass      = VoisentryNodeUpdate.Config.class)
public class VoisentryNodeUpdate extends AbstractDecisionNode {

    private final Logger logger = LoggerFactory.getLogger(VoisentryNodeUpdate.class);
     ...
     */
    @Inject
    public VoisentryNodeUpdate(@Assisted Config config, @Assisted Realm realm, AnnotatedServiceRegistry serviceRegistry) throws NodeProcessException {
        this.config = config;
        this.realm = realm;
        try {
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        ...
        logger.info("VoisentryUpdateNode started");
